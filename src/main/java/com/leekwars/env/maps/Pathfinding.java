...
import com.leekwars.env.area.Area;
...
public class Pathfinding {
	...
	public static List<Cell> getPathTowardLine(Cell start, Cell linecell1, Cell linecell2) {
	...
	public static List<Cell> getPathAwayFromLine(Cell start, Cell linecell1, Cell linecell2, int max_distance) {
	...
	public static List<Cell> getPathAway(Cell start, List<Cell> bad_cells, int max_distance) {
		long startt;
		if (DEBUG)
	...
	public static List<Cell> getPathAwayMin(Cell start, List<Cell> bad_cells, int max_distance) {
		long startt;
		if (DEBUG)
			startt = System.currentTimeMillis();
		int curent_distance = getDistance2(start, bad_cells);
	...
	public static List<Cell> getAStarPath(Cell c1, Cell[] cell, List<Cell> cells_to_ignore) {
		return getAStarPath(c1, Arrays.asList(cell), cells_to_ignore);
	}

	public static List<Cell> getAStarPath(Cell c1, Cell[] cell) {
		return getAStarPath(c1, Arrays.asList(cell), null);
	}

	public static List<Cell> getAStarPath(Cell c1, List<Cell> endCells) {
		return getAStarPath(c1, endCells, null);
	}

	public static List<Cell> getAStarPath(Cell c1, List<Cell> endCells, List<Cell> cells_to_ignore) {
